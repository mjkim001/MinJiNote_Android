...
import com.example.androidproject01.databinding.FragmentWriteMessageBinding;
...
public class WriteMessageFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_write_message, container, false);
