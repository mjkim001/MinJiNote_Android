...
import com.example.androidproject01.MySendMailRecyclerViewAdapter;
...
public class SendMailFragment extends Fragment {
    ...
    MySendMailRecyclerViewAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new MySendMailRecyclerViewAdapter(arrayList, activity);
    ...
    void setMailList(String id){
        arrayList.clear();
        cursor = mailDBHelper.getMySendMailList(id);
